...
author = "Iceman (modified to work with latest client by TomHarkness)"
desc =
[[
...
function main(args)
	...
	-- identify tag
	result, err = reader.read14443a(true, false)
	...
	for sector=1,numSectors do
		...
		for targetkeytype=0,1 do
			...
			if sector == 1 and targetkeytype == 0 then
				...
				local err, foundkey = cmds.CMD_HF_MF_HARD, arg1 = blockno, arg2 = keytype, arg3 = key, arg4 = trgblockno tostring(targetkeytype), arg5 = trgkey, 0,0,0,0
